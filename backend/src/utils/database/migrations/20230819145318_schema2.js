  ...
  return (
    knex.schema
      ...
      .createTable("user", (table) => {
        ...
        table.integer("main_address_id").unsigned().notNullable()
        table.integer("shipping_address_id").unsigned().notNullable()
        table.integer("role_id").unsigned().defaultTo(1).notNullable()

        table.foreign("main_address_id").references("address.id")
        table.foreign("shipping_address_id").references("address.id")
        table.foreign("role_id").references("role.id")
      })
      ...
      .createTable("order", (table) => {
        ...
        table.integer("anonymous_user_id").unsigned()
        ...
        table.foreign("user_id").references("user.id")
        table.foreign("anonymous_user_id").references("anonymous_user.id")
